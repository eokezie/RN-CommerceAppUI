...
import {ShoppingBasket, MoveLeft, Heart} from 'lucide-react-native';
...
const DetailsScreen = ({
  ...
  return (
    <View style={{flex: 1}}>
      <Image
        source={{
          uri: 'https://images.unsplash.com/photo-1637858768784-cfa1da55b4e8?q=80&w=3387&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        }}
        style={{flex: 1}}
      />
      ...
      <SafeAreaView
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <ShoppingBasket size={24} color={'#fff'} />
          </TouchableOpacity>
        </View>
      </SafeAreaView>
